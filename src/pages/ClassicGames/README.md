...
Classic Games lets you explore a curated set of historical chess games on an interactive board. A random game is selected when the page loads, but you can choose a specific game from the dropdown or use the shuffle button to jump to another one.
...
- **`Description`** — short historical context.
